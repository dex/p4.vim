...
nmap <buffer> <unique> <C-d> <Plug>P4Diff2
noremap <buffer> <unique> <script> <Plug>P4Diff2 <SID>Diff2
noremap <buffer> <SID>Diff2 :call <SID>RunCL(split(getline("."))[1])<CR>

if !exists("*s:RunCL")
    function! s:RunCL(obj)
	if stridx(a:obj, "#") == 0
	    execute "CL ".getline(1)." ".strpart(a:obj, 1)
	else
	    execute "CL ". a:obj
	endif
    endfunction
